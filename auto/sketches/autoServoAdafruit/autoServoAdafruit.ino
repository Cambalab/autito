...
int sonarData = 0; // Esta variable guardara el valor de sensado del ultrasonido.
...
Adafruit_DCMotor *motorIzq = AFMS.getMotor(1);
Adafruit_DCMotor *motorDer = AFMS.getMotor(3);
